...
_Entity or requirement removed in to_revision._
...
URI: [pbs:DeletionChange](https://schema.pragmaticbim.ch/DeletionChange)
...
```mermaid
 classDiagram
    ...
    click DeletionChange href "../DeletionChange/"
      ...
      DeletionChange : from_state_ref
        
          
    
        
        
        DeletionChange --> "0..1" StateRef : from_state_ref
      ...
      DeletionChange : to_state_ref
        
          
    
        
        
        DeletionChange --> "0..1" StateRef : to_state_ref
        click StateRef href "../StateRef/"
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:DeletionChange](https://schema.pragmaticbim.ch/DeletionChange) |
