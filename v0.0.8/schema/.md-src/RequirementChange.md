...
_Change to a requirement entity or its fields._
...
URI: [pbs:RequirementChange](https://schema.pragmaticbim.ch/RequirementChange)
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:RequirementChange](https://schema.pragmaticbim.ch/RequirementChange) |
...
| ---  | --- | --- | --- |
| [affected_requirement](affected_requirement.md) | 0..1 <br/> [Requirement](Requirement.md) | Requirement entity affected by this change. | direct |
...
| ---  | ---  |
| self | pbs:RequirementChange |
| native | pbs:RequirementChange |
| exact | prov:Activity |
