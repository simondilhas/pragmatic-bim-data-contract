...
URI: [pbs:BuildingContext](https://schema.pragmaticbim.ch/BuildingContext)
...
```mermaid
 classDiagram
    ...
    click BuildingContext href "../BuildingContext/"
      ...
      BuildingContext : time_items
        
          
    
        
        
        BuildingContext --> "*" TimeItem : time_items
        click TimeItem href "../TimeItem/"
    

        
      BuildingContext : time_plans
        
          
    
        
        
        BuildingContext --> "*" TimePlan : time_plans
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:BuildingContext](https://schema.pragmaticbim.ch/BuildingContext) |
