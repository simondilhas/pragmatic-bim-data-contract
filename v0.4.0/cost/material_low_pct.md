...
# Slot: material_low_pct 


_Lower material bound as signed fraction of material_cost (≤ 0)._
...
URI: [cost:material_low_pct](https://schema.pragmaticbim.ch/cost/material_low_pct)
...
| ---  | ---  |
| self | cost:material_low_pct |
| native | cost:material_low_pct |
