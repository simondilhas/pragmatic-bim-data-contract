...
_Lower labor bound as signed fraction of labor hours (≤ 0)._
...
URI: [cost:labor_low_pct](https://schema.pragmaticbim.ch/cost/labor_low_pct)
...
| ---  | ---  |
| self | cost:labor_low_pct |
| native | cost:labor_low_pct |
