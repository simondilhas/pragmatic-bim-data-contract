...
- **description (de):** Ordnet abstrakte Tuer-Verbindungsprodukte KBOB-Oekobilanz-Gruppe-12-Tuerbaugruppen (m2-Bezugseinheit) zu. pcs-bewertete Tueren nutzen Standard-Tuerblattflaeche in kbob-ecobilans-price-unit-defaults.json.
- **description (en):** Maps abstract door connector products to KBOB ecobilans group 12 door assembly rows (m2 reference unit). pcs-priced doors use default door leaf area in kbob-ecobilans-price-unit-defaults.json.
