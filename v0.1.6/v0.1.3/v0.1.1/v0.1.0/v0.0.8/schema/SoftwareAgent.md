...
_Automated actor (integration, bot, or pipeline) acting in workflow roles._
...
URI: [pbs:SoftwareAgent](https://schema.pragmaticbim.ch/SoftwareAgent)
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:SoftwareAgent](https://schema.pragmaticbim.ch/SoftwareAgent) |
...
| ---  | --- | --- | --- |
| [operated_by](operated_by.md) | 0..1 <br/> [Company](Company.md) | Organization accountable for this software agent. | direct |
| [software_version](software_version.md) | 0..1 <br/> [String](String.md) | Optional deployed version label for the software agent. | direct |
| [service_endpoint](service_endpoint.md) | 0..1 <br/> [Uriorcurie](Uriorcurie.md) | Optional URI of the running service or integration endpoint. | direct |
...
| ---  | ---  |
| self | pbs:SoftwareAgent |
| native | pbs:SoftwareAgent |
