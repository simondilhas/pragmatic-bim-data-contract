...
_Deliverable or documentation requirement (model LOD, O&M manual, export format, etc.)._
...
URI: [pbs:DeliverableRequirement](https://schema.pragmaticbim.ch/DeliverableRequirement)
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:DeliverableRequirement](https://schema.pragmaticbim.ch/DeliverableRequirement) |
...
| ---  | --- | --- | --- |
| [deliverable_kind](deliverable_kind.md) | 0..1 <br/> [String](String.md) | Deliverable type label (for example coordination model, O&M manual, as-built record). | direct |
...
| ---  | ---  |
| self | pbs:DeliverableRequirement |
| native | pbs:DeliverableRequirement |
...
description: Deliverable or documentation requirement (model LOD, O&M manual, export
  format, etc.).
...
attributes:
  deliverable_kind:
    ...
    description: Deliverable type label (for example coordination model, O&M manual,
      as-built record).
    from_schema: https://schema.pragmaticbim.ch
    rank: 1000
