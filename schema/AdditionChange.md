...
_New entity or requirement introduced in to_revision._
...
URI: [pbs:AdditionChange](https://schema.pragmaticbim.ch/AdditionChange)
...
```mermaid
 classDiagram
    ...
    click AdditionChange href "../AdditionChange/"
      ...
      AdditionChange : document_storage_link
        
      AdditionChange : from_revision
        
      AdditionChange : from_state_ref
        
          
    
        
        
        AdditionChange --> "0..1" StateRef : from_state_ref
      ...
      AdditionChange : to_state_ref
        
          
    
        
        
        AdditionChange --> "0..1" StateRef : to_state_ref
        click StateRef href "../StateRef/"
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:AdditionChange](https://schema.pragmaticbim.ch/AdditionChange) |
...
| ---  | ---  |
| self | pbs:AdditionChange |
| native | pbs:AdditionChange |
| exact | prov:Activity |
