...
_Optional semantic URI for linking the entity instance to an external ontology concept._





URI: [pbs:meaning_uri](https://example.org/pragmatic-bim-data-contract/meaning_uri)
Alias: meaning_uri
...
| ---  | ---  |
| self | pbs:meaning_uri |
| native | pbs:meaning_uri |
