...
# Slot: quantity_values 


_Quantities associated with the entity._





URI: [pbs:quantity_values](https://example.org/pragmatic-bim-data-contract/quantity_values)
...
| ---  | ---  |
| self | pbs:quantity_values |
| native | pbs:quantity_values |
