 ...
 classDiagram
    ...
    click PropertyDelta href "../PropertyDelta/"
      ...
      PropertyDelta : property_path_kind
        ...
        click PropertyPathKind href "../PropertyPathKind/"
...
| ---  | --- | --- | --- |
| [property_path](property_path.md) | 1 <br/> [String](String.md) | Canonical path to the changed field | direct |
...
| [from_value](from_value.md) | 0..1 <br/> [String](String.md) | Prior value serialized as text | direct |
| [to_value](to_value.md) | 0..1 <br/> [String](String.md) | New value serialized as text | direct |
...
| [ifc_attribute_name](ifc_attribute_name.md) | 0..1 <br/> [String](String.md) | IFC attribute name when property_path_kind is ifc_attribute (for example Name... | direct |
...
| ---  | --- | --- | --- |
| [Change](Change.md) | [property_delta](property_delta.md) | range | [PropertyDelta](PropertyDelta.md) |
