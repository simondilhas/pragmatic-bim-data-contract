...
| ---  | --- | --- | --- |
| [property_key](property_key.md) | 1 <br/> [MaterialPropertyKey](MaterialPropertyKey.md) | Canonical key inside the domain; constrained via subclass slot_usage to a domain-specific enum. | [PerformanceProperty](PerformanceProperty.md) |
