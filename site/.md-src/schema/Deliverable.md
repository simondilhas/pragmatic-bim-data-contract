...
_Outcome or handover item produced within a project._
...
URI: [pbs:Deliverable](https://schema.pragmaticbim.ch/Deliverable)
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:Deliverable](https://schema.pragmaticbim.ch/Deliverable) |
...
| ---  | --- | --- | --- |
| [deliverable_code](deliverable_code.md) | 0..1 <br/> [String](String.md) | External or internal deliverable identifier within a project. | direct |
...
| ---  | ---  |
| self | pbs:Deliverable |
| native | pbs:Deliverable |
