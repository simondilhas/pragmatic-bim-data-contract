...
_Region code where material_factor and labor_factor are 1.0 (for example DE_MU)._
...
URI: [cost:anchor_region](https://schema.pragmaticbim.ch/cost/anchor_region)
...
| ---  | ---  |
| self | cost:anchor_region |
| native | cost:anchor_region |
