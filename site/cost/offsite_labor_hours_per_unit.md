...
# Slot: offsite_labor_hours_per_unit 


_Factory/offsite labor in person-hours per price_unit._
...
URI: [cost:offsite_labor_hours_per_unit](https://schema.pragmaticbim.ch/cost/offsite_labor_hours_per_unit)
...
| ---  | ---  |
| self | cost:offsite_labor_hours_per_unit |
| native | cost:offsite_labor_hours_per_unit |
