...
# Slot: affected_subject 


_Optional typed reference to the changed graph entity when the subject is in the project graph._
...
URI: [pbs:affected_subject](https://schema.pragmaticbim.ch/affected_subject)
...
| ---  | ---  |
| self | pbs:affected_subject |
| native | pbs:affected_subject |
