...
# Slot: onsite_labor_hours_high 


_Derived upper onsite labor hours per price unit._
...
URI: [cost:onsite_labor_hours_high](https://schema.pragmaticbim.ch/cost/onsite_labor_hours_high)
...
| ---  | ---  |
| self | cost:onsite_labor_hours_high |
| native | cost:onsite_labor_hours_high |
