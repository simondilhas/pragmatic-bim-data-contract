...
# Slot: delivered_material_cost_low 


_Derived lower delivered_material_cost in EUR._
...
URI: [cost:delivered_material_cost_low](https://schema.pragmaticbim.ch/cost/delivered_material_cost_low)
...
| ---  | ---  |
| self | cost:delivered_material_cost_low |
| native | cost:delivered_material_cost_low |
