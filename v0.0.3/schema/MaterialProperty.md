...
URI: [pbs:MaterialProperty](https://example.org/pragmatic-bim-data-contract/MaterialProperty)
 ...
 classDiagram
    ...
    click MaterialProperty href "../MaterialProperty/"
      ...
      MaterialProperty : property_key
        ...
        click MaterialPropertyKey href "../MaterialPropertyKey/"
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:MaterialProperty](https://example.org/pragmatic-bim-data-contract/MaterialProperty) |
...
| ---  | --- | --- | --- |
| [property_key](property_key.md) | 1 <br/> [MaterialPropertyKey](MaterialPropertyKey.md) | Canonical key inside the domain; constrained via subclass slot_usage to a dom... | [PerformanceProperty](PerformanceProperty.md) |
