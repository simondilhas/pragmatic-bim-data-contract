...
# Slot: performance_properties 


_Normalized, strongly typed domain properties (fire/acoustic/thermal/structural/ security/material) extracted from raw IFC PropertySet values._
...
URI: [pbs:performance_properties](https://example.org/pragmatic-bim-data-contract/performance_properties)
...
| Property | Value |
| --- | --- |
| Range | [PerformanceProperty](PerformanceProperty.md) |
...
| ---  | ---  |
| self | pbs:performance_properties |
| native | pbs:performance_properties |
