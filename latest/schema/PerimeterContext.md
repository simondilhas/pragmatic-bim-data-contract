...
URI: [pbs:PerimeterContext](https://schema.pragmaticbim.ch/PerimeterContext)
...
```mermaid
 classDiagram
    ...
    click PerimeterContext href "../PerimeterContext/"
      ...
      PerimeterContext : time_items
        
          
    
        
        
        PerimeterContext --> "*" TimeItem : time_items
        click TimeItem href "../TimeItem/"
    

        
      PerimeterContext : time_plans
        
          
    
        
        
        PerimeterContext --> "*" TimePlan : time_plans
