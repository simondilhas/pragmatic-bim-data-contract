...
# Slot: change_severity 


_Optional severity independent of change type._
...
URI: [pbs:change_severity](https://schema.pragmaticbim.ch/change_severity)
...
| Property | Value |
| --- | --- |
| Range | [ChangeSeverity](ChangeSeverity.md) |
...
| ---  | ---  |
| self | pbs:change_severity |
| native | pbs:change_severity |
