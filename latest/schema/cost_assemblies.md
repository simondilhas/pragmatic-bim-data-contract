...
# Slot: cost_assemblies 


_Aggregated unit prices associated with this entity._





URI: [pbs:cost_assemblies](https://example.org/pragmatic-bim-data-contract/cost_assemblies)
...
| Property | Value |
| --- | --- |
| Range | [CostAssembly](CostAssembly.md) |
...
| ---  | ---  |
| self | pbs:cost_assemblies |
| native | pbs:cost_assemblies |
