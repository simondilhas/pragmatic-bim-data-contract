...
_Source revision number for this change._
...
URI: [pbs:from_revision](https://schema.pragmaticbim.ch/from_revision)
...
| ---  | ---  |
| self | pbs:from_revision |
| native | pbs:from_revision |
