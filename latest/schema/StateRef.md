 ...
 classDiagram
    ...
    click StateRef href "../StateRef/"
      ...
      StateRef : state_ref_kind
        ...
        click StateRefKind href "../StateRefKind/"
...
| [state_ref_format](state_ref_format.md) | 0..1 <br/> [String](String.md) | Optional serialization format (for example ifc, gltf, pdf, docx, markdown, pl... | direct |
