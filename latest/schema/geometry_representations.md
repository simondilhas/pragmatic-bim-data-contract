...
# Slot: geometry_representations 


_Geometry references associated with the entity. A single element may link to multiple geometry representations to serve different intents (authoring, coordination, analysis, visualization) without duplicating the element itself._
...
URI: [pbs:geometry_representations](https://example.org/pragmatic-bim-data-contract/geometry_representations)
...
| Property | Value |
| --- | --- |
| Range | [GeometryRepresentation](GeometryRepresentation.md) |
...
| ---  | ---  |
| self | pbs:geometry_representations |
| native | pbs:geometry_representations |
...
description: 'Geometry references associated with the entity. A single element may
  link to multiple geometry representations to serve different intents (authoring,
