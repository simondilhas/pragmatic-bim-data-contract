...
_Portfolio or capital program scope grouping related projects._
...
URI: [pbs:Program](https://schema.pragmaticbim.ch/Program)
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:Program](https://schema.pragmaticbim.ch/Program) |
| Tree Root | Yes |
...
| ---  | --- | --- | --- |
| [program_code](program_code.md) | 0..1 <br/> [String](String.md) | External or internal program identifier. | direct |
...
| ---  | --- | --- | --- |
| [Project](Project.md) | [parent_program](parent_program.md) | range | [Program](Program.md) |
