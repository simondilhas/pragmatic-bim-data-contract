...
# Slot: material_cost_high 


_Derived upper material_cost in EUR (net, VAT excluded)._
...
URI: [cost:material_cost_high](https://schema.pragmaticbim.ch/cost/material_cost_high)
...
| ---  | ---  |
| self | cost:material_cost_high |
| native | cost:material_cost_high |
