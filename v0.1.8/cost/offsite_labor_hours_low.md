...
# Slot: offsite_labor_hours_low 


_Derived lower offsite labor hours per price unit._
...
URI: [cost:offsite_labor_hours_low](https://schema.pragmaticbim.ch/cost/offsite_labor_hours_low)
...
| ---  | ---  |
| self | cost:offsite_labor_hours_low |
| native | cost:offsite_labor_hours_low |
