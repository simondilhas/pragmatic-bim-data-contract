...
# Slot: delivered_material_cost_high 


_Derived upper delivered_material_cost in EUR._
...
URI: [cost:delivered_material_cost_high](https://schema.pragmaticbim.ch/cost/delivered_material_cost_high)
...
| ---  | ---  |
| self | cost:delivered_material_cost_high |
| native | cost:delivered_material_cost_high |
