...
# Slot: material_high_pct 


_Upper material bound as signed fraction of material_cost (≥ 0)._
...
URI: [cost:material_high_pct](https://schema.pragmaticbim.ch/cost/material_high_pct)
...
| ---  | ---  |
| self | cost:material_high_pct |
| native | cost:material_high_pct |
