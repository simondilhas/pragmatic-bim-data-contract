...
URI: [pbs:LegalSiteContext](https://example.org/pragmatic-bim-data-contract/LegalSiteContext)
...
| Property | Value |
| --- | --- |
| Class URI | [pbs:LegalSiteContext](https://example.org/pragmatic-bim-data-contract/LegalSiteContext) |
