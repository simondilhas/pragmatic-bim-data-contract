...
_Parent level/storey context reference._
...
| Domain Of | [PhysicalElement](PhysicalElement.md), [SpatialContext](SpatialContext.md), [Space](Space.md) |
...
| ---  | ---  |
| self | pbs:parent_level |
| native | pbs:parent_level |
